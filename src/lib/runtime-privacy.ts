...
const SENSITIVE_TEXT_PATTERNS = [
  ...
  /\b(?:ma|mon|mes|my)\s+(?:commande|order|facture|invoice|adresse|address|email|courriel|t[ée]l[ée]phone|compte|account|mot de passe|password)\b/iu,
  /\b(?:commande|order|facture|invoice|colis|suivi|tracking)\s*(?:n(?:uméro|umber)?|n[o°.]|#|:)?\s*[A-Z0-9][A-Z0-9-]{3,}\b/iu,
